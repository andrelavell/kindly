...
export const stores: Store[] = [
  ...
  { name: "Sam's Club", category: "Major Retailers", popular: true, domain: "samsclub.com" },
  { name: "Kohl's", category: "Major Retailers", popular: true },
  ...
  { name: "Marshalls", category: "Major Retailers", popular: true },
  { name: "TJ Maxx", category: "Major Retailers", popular: true },
  { name: "HomeGoods", category: "Major Retailers", popular: true },
  ...
  { name: "Zara", category: "Fashion & Apparel", popular: true },
  { name: "Uniqlo", category: "Fashion & Apparel", popular: true },
  { name: "ASOS", category: "Fashion & Apparel", popular: true },
  { name: "The North Face", category: "Fashion & Apparel", popular: true },
  { name: "Levi's", category: "Fashion & Apparel", popular: true },
  { name: "Urban Outfitters", category: "Fashion & Apparel", popular: true },
  { name: "Patagonia", category: "Fashion & Apparel" },
  { name: "Gap", category: "Fashion & Apparel", popular: true },
  { name: "Old Navy", category: "Fashion & Apparel", popular: true },
  { name: "Banana Republic", category: "Fashion & Apparel" },
  { name: "Forever 21", category: "Fashion & Apparel" },
  { name: "Macy's", category: "Fashion & Apparel", popular: true },
  { name: "Nordstrom", category: "Fashion & Apparel", popular: true },
  { name: "J.Crew", category: "Fashion & Apparel" },
  { name: "Anthropologie", category: "Fashion & Apparel" },
  { name: "Puma", category: "Fashion & Apparel" },
  { name: "Under Armour", category: "Fashion & Apparel", popular: true },

  // Electronics & Tech
  { name: "Best Buy", category: "Electronics & Tech", popular: true },
  { name: "Apple", category: "Electronics & Tech", popular: true },
  { name: "Samsung", category: "Electronics & Tech", popular: true },
  { name: "Microsoft", category: "Electronics & Tech", popular: true },
  { name: "Dell", category: "Electronics & Tech", popular: true },
  { name: "HP", category: "Electronics & Tech" },
  { name: "Lenovo", category: "Electronics & Tech" },
  { name: "Newegg", category: "Electronics & Tech", popular: true },
  { name: "B&H Photo", category: "Electronics & Tech" },
  { name: "GameStop", category: "Electronics & Tech", popular: true },
  { name: "Bose", category: "Electronics & Tech" },
  { name: "Sony", category: "Electronics & Tech", popular: true },
  ...
  { name: "Home Depot", category: "Home & Garden", popular: true },
  { name: "Lowe's", category: "Home & Garden", popular: true },
  { name: "Bed Bath & Beyond", category: "Home & Garden", popular: true },
  { name: "Crate & Barrel", category: "Home & Garden", popular: true },
  { name: "West Elm", category: "Home & Garden" },
  { name: "Pottery Barn", category: "Home & Garden", popular: true },
  { name: "Williams Sonoma", category: "Home & Garden", popular: true },
  { name: "Restoration Hardware", category: "Home & Garden" },
  { name: "The Container Store", category: "Home & Garden" },
  { name: "Five Star", category: "Home & Garden" },
  { name: "Poppin", category: "Home & Garden" },
  { name: "Quill", category: "Home & Garden" },
  { name: "School Specialty", category: "Home & Garden" },
  { name: "Mead", category: "Home & Garden" },
  { name: "Post-it", category: "Home & Garden" },
  { name: "Moleskine", category: "Home & Garden" },
